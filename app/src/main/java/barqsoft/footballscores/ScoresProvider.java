...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final String SCORES_BY_SCORE = DatabaseContract.scores_table.HOME_GOALS_COL + " NOT LIKE ?"; // new code
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "home_goals", MATCHES_WITH_SCORE); // URI to get matches who have score.
        return matcher;
    }
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreWithLeague().toString()))
           {
            ...
            else if (link.contentEquals(DatabaseContract.scores_table.buildScoreWithScore().toString()))
           {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (match)
        {
            ...
            case MATCHES_WITH_SCORE: retCursor = mOpenHelper.getReadableDatabase().query(
                    DatabaseContract.SCORES_TABLE,
                    projection,SCORES_BY_SCORE, selectionArgs, null, null, sortOrder); break;
