...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        public static final String FULL_DATE = "full_date"; // column with the full date
        ...
        public static Uri buildScoreWithScore(){
            return BASE_CONTENT_URI.buildUpon().appendPath("home_goals").build();
        }
    }
    //URI data
